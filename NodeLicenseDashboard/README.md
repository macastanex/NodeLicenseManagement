# Node License Dashboard

This app was generated by `slcli webapp new NodeLicenseDashboard` as a hosted Angular 20 starter for SystemLink.
...
- three dashboard-oriented starter routes ready for metrics, tables, and record drill-down

## Enabled Starter Routes

home, datasets, assets
...
```bash
slcli webapp publish dist/nodelicensedashboard --name "Node License Dashboard"
```
